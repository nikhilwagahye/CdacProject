...
/**
 * Created by nikhilkumar.waghaye on 23-01-2018.
 */

public class BGTaskForShoppingBooks extends AsyncTask<String, String, JSONArray> {
    Activity context;
     ...
     * Constructor
     */
    public BGTaskForShoppingBooks(Activity context, IDataResponse interfaceData, String api) {
